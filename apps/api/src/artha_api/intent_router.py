...
- capture_transaction: a statement describing a new expense, income, transfer, card payment,
  or other currently supported money event the user wants to record.
...
- unsupported: advice, investing, lending, database administration, ledger mutation requests,
  commands to move real money, settlements (not supported yet), or anything outside transaction
  capture and read-only ledger questions.
